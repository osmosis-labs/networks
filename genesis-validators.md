...
You can now download the "pregenesis" file for the chain.  This is genesis file that is missing the gentxs.
...
`osmosisd` can open more than 1024 files (which is default maximum) concurrently. You will want to increase this limit. 
